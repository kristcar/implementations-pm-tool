...
def _seed_templates(conn):
    ...
    skio_tasks = [
        ...
        ("Theme & Integration", "Check theme codebase for reference to \"selling_plan\" to ensure creating in Skio won't affect the frontend", "", "ie", 3, 50),
        ...
        ("Theme & Integration", "Review current workflows / automations that \"update\" a subscription", "", "ie", 2, 170),
